...
yields <- read_csv("yield.csv")

tiers <- read_csv('Tier_data.csv')
...
Conversion_Factors <- read_csv('Conversion_Factors.csv')
...
MSFS_df <- read_csv(paste(path_to_ThisPeriod,'/sales_and_distribution/AU_Marijuana_Establishment_Facility_Statistics.csv',sep=''))
MSFS_df<- prepMSFSFile(MSFS_df)

MSFSLastPeriod_df <- read_csv(paste(path_to_LastPeriod,'/sales_and_distribution/AU_Marijuana_Establishment_Facility_Statistics.csv',sep=''))
...
MELA_Pending_df<- read_csv(paste(path_to_ThisPeriod,'/applications_and_licensure/AU_Marijuana_Establishment_License_and_Applications-Approved_Pending_Re-Opened.csv',sep=''))

MELA_P_df <- prepMelaFile(MELA_Pending_df)


MELA_Pending_LastPeriod_df<- read_csv(paste(path_to_LastPeriod,'/applications_and_licensure/AU_Marijuana_Establishment_License_and_Applications-Approved_Pending_Re-Opened.csv',sep=''))
...
MELA_Approved_df<- read_csv(paste(path_to_ThisPeriod,'/applications_and_licensure/AU_Marijuana_Establishment_License_and_Applications-Approved.csv',sep=''))
MELA_A_df <- prepMelaFile(MELA_Approved_df)

MELA_Approved_df <- prepMelaApprovedFile(MELA_Approved_df)

MELA_Approved_LastPeriod_df<- read_csv(paste(path_to_LastPeriod,'/applications_and_licensure/AU_Marijuana_Establishment_License_and_Applications-Approved.csv',sep=''))
...
MPPO_df<- read_csv(paste(path_to_ThisPeriod,'/sales_and_distribution/AU_Average_Monthly_Price_per_Ounce_for_Adult-Use_Cannabis.csv',sep=''))
